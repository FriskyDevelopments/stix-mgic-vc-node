...
function stateLabel(state: MediaAdapter['state']) {
  if (state === 'ready') return 'READY'
  if (state === 'degraded') return 'LIMITED'
  if (state === 'not_implemented') return 'NOT IMPLEMENTED'
  return 'DISABLED'
}
